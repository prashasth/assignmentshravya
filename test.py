...
def ipinfo():
       ...
       print (" ")
       slowprint("\033[1;36m =====================================")
       slowprint("\033[1;33m|        Coded By Shravya           |")
       slowprint("\033[1;36m =====================================")
       slowprint("\033[1;91m|          www.pesit.com           |")
       slowprint("\033[1;36m =====================================")
       print (" ")
...
def about():
       ...
       slowprint ("\033[1;33m" + "         [+] Autor         =>\033[1;36m" + " Shravya")
       slowprint ("\033[1;33m" + "         [+] Latest Update =>\033[1;36m" + " 28/4/2022")
       slowprint ("\033[1;91m -----------------------------------------------")
       slowprint ("\033[1;95m" + "          [+] www.pesit.com [+]          ")
       slowprint ("\033[1;91m -----------------------------------------------")
